...
var imageRepository = new function() {
	...
	this.bullet.src = "img/laser.png";
	this.enemy.src = "img/UFO.gif";
	this.enemyBullet.src = "img/megalaser.png";
}
...
function Game() {
	...
	this.init = function() {
		...
		if (this.bgCanvas.getContext) {
			...
			this.backgroundAudio = new Audio("sound.wav");
			this.backgroundAudio.loop = true;
			this.backgroundAudio.volume = .25;
			this.backgroundAudio.load();

			this.gameOverAudio = new Audio("sound.wav");
...
function SoundPool(maxSize) {
	...
	this.init = function(object) {
		if (object == "laser") {
			...
			for (var i = 0; i < size; i++) {
				var explosion = new Audio("sounds.wav");
				explosion.volume = .1;
				explosion.load();
				pool[i] = explosion;
			}
